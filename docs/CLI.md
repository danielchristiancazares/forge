# Forge CLI Architecture Documentation
...
|----------|-------------|
| `docs/TUI_ARCHITECTURE.md` | Comprehensive TUI rendering documentation |
| `docs/ENGINE_ARCHITECTURE.md` | Engine state machine and App API |
| `docs/CONTEXT_INFINITY.md` | Context management system |
